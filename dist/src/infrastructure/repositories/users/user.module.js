...
UserModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([otps_entity_1.Otp, user_entity_1.User]), mail_module_1.MailModule, otp_module_1.OtpModule, bcrypt_module_1.BcryptModule],
